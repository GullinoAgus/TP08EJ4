...
${OBJECTDIR}/_ext/ef515e5c/clasificar.o: ../../Desktop/clasificar.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/ef515e5c/clasificar.o ../../Desktop/clasificar.c

${OBJECTDIR}/_ext/ef515e5c/main.o: ../../Desktop/main.c
	${MKDIR} -p ${OBJECTDIR}/_ext/ef515e5c
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/ef515e5c/main.o ../../Desktop/main.c
